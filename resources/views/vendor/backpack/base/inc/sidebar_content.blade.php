...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('section') }}'><i class='nav-icon la la-puzzle-piece'></i> {{ __('Sections') }}</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('question') }}'><i class='nav-icon la la-question'></i> {{ __('Questions') }}</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('entry') }}'><i class='nav-icon la la-question'></i> {{ __('Entries') }}</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('answer') }}'><i class='nav-icon la la-check'></i> {{ __('Answers') }}</a></li>

<hr class="w-100 my-2">
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('operator') }}'><i class='nav-icon la la-user'></i> {{ __('Operators') }}</a></li>
